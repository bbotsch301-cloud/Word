    ...
    <main className="min-h-screen flex items-center justify-center px-4 sm:px-6 py-8 sm:py-12">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="font-serif text-2xl font-bold text-text-primary mt-4">Sign in</h1>
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className="flex items-center justify-center gap-2 h-11 rounded-lg border border-border bg-surface text-text-primary text-sm font-medium hover:border-accent/40 transition-colors"
          >
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="max-w-md mx-auto px-4 py-16"><div className="h-64 bg-surface border border-border rounded-xl animate-pulse" /></div>}>
      <LoginPageInner />
    </Suspense>
  );
}
